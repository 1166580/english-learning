...
export default function BookCard({ book, progress, completedCount }: BookCardProps) {
  return (
    <Link
      to={`/book/${book.id}`}
      className="block bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden no-underline hover:-translate-y-1 border border-gray-100 dark:border-gray-700"
    >
      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-3">
          <div>
            ...
            <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 mt-1">{book.nameCn}</h2>
